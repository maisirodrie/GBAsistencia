...
export const FAJA_META = {
    // ── Adulto ─────────────────────────────────────────
    'Branca':            { bg: '#e2e8f0', text: '#0f172a', border: '#94a3b8',  stripeColor: '#ffffff' },
    ...
    'Preta':             { bg: '#020617', text: '#ef4444', border: '#dc2626',  stripeColor: '#ffffff', tipColor: '#ef4444' },
    // ── Infantil ────────────────────────────────────────
    ...
    'Amarela e Branca':  { bg: '#eab308', bg2: '#f1f5f9', text: '#713f12', border: '#eab308',  stripeColor: '#ffffff' },
    'Amarela':           { bg: '#eab308', text: '#1c1917', border: '#713f12',  stripeColor: '#ffffff' },
    'Amarela e Preta':   { bg: '#eab308', bg2: '#0f172a', text: '#fde68a', border: '#1c1917',  stripeColor: '#ffffff' },
    'Laranja e Branca':  { bg: '#f97316', bg2: '#f1f5f9', text: '#7c2d12', border: '#f97316',  stripeColor: '#ffffff' },
    ...
    'Verde e Branca':    { bg: '#16a34a', bg2: '#f1f5f9', text: '#14532d', border: '#16a34a',  stripeColor: '#ffffff' },
